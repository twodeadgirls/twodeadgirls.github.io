...
<p>
The purple shaded area represents a theoretical crime scene area of 120 square miles based on an estimated travel time from the last verified sighting (15 min out) to potential crime scene. Note I can signiifcantly narrow this in the coming days with adding more data and the map will reflect that as I add it to the spreadsheets. So think fluid.
  <p>Assumptions:<p>
<ul>
